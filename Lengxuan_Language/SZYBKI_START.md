# Lengxuan - Przewodnik Szybkiego Startu 🚀

## 🎯 Naucz Się Lengxuan w 15 Minut!

### Krok 1: Podstawowa Wymowa (2 minuty)

**Spółgłoski** - wymowa jak w polskim:
- p, t, k, b, d, g, m, n, f, s, l, r, j
...
- **ś** = jak w "śmiech"
- **dź** = jak w "dźwig"
- **h** = jak niemieckie "ach" (tylnojęzykowe)
- **ł** = jak polskie "ł" (półotwarta /w/)
- **ng** = jak angielskie "kong-kong"

**Samogłoski:**
- **a, sen-zhua, i, o, u** = jak w polskim
- **ü** = jak niemieckie "ü" (München) ← **WAŻNE!**
- **y** = jak polskie "y" (ryba)

---

### Krok 2: 20 Najważniejszych Słów (3 minuty)
...
### Krok 3: Podstawowa Składnia (5 minut)
...
### Krok 4: Pierwsze Zdania (5 minut)
...
### Poziom 1: Podstawy ✅
- [x] Nauczyłeś się wymowy
- [x] Znasz 20 podstawowych słów
- [x] Rozumiesz prostą składnię
- [x] Potrafisz stworzyć proste zdania
...
- [ ] Idiomy i przysłowia (`03_Slownik/kultura.md`)
- [ ] Złożone struktury gramatyczne

### Poziom 4: Mistrz
- [ ] Pisz własne dialogi
- [ ] Twórz opisy scen walki
- [ ] Używaj honorifics w hierarchicznych relacjach
...
- [🔤 Transkrypcja i Wymowa](01_Fonologia/transkrypcja.md)
- [📐 Składnia](02_Gramatyka/skladnia.md)
- [📚 Słownik (Lengxuan → Polski)](03_Slownik/slownik_lengxuan_polski.md)
- [📚 Słownik (Polski → Lengxuan)](03_Slownik/slownik_polski_lengxuan.md)
- [🗣️ Dialogi](04_Przyklady/dialogi.md)
